 ...
 * admin-only (Editor and above in the share menu) unless the artifact
 * opens them to the interact level (members at Contributor and above;
 * not Viewers or Commenters) at publish time:
